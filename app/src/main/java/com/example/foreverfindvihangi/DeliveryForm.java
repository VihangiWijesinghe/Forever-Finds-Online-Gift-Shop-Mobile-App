...
import com.example.foreverfindvihangi.database.DBReference;
...
public class DeliveryForm extends AppCompatActivity {
    ...
    private void insertDeilveryDetails() {
            ...
            if(TextUtils.isEmpty(resFullName.getText().toString())){
                ...
                com.example.foreverfindvihangi.model.Orders or1 = new com.example.foreverfindvihangi.model.Orders();
